...
public interface DomicilioRepository extends JpaRepository<Domicilio, Long> {
    ...
    Page<Domicilio> findByEstadoDomicilio(String estadoDomicilio, Long idUsuario, Pageable pageable);
    ...
    Page<Domicilio> findByVehiculo_IdPropietario_IdUsuario(Long idUsuario, Pageable pageable);
